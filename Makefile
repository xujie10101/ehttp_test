...
# CXX=/home/ubuntu/work/202_mips/OpenWrt-SDK-ramips-for-redhat-x86_64-realase/staging_dir/toolchain-mipsel_24kec+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/bin/mipsel-openwrt-linux-g++
# CC=/home/ubuntu/work/202_mips/OpenWrt-SDK-ramips-for-redhat-x86_64-realase/staging_dir/toolchain-mipsel_24kec+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/bin/mipsel-openwrt-linux-gcc
CXX=g++
CC=gcc
CXXFLAGS += -g -Wall
LDFLAGS += -pthread
...
deps: prepare 
	make -C deps/http-parser package CC=$(CC)
	make -C deps/json-cpp CXX=$(CXX)
	make -C deps/multipart-parser-c CC=$(CC)
...
test: libehttp.a demo version_4http hello_server http_server_test sim_parser_test issue5_server threadpool_test string_utils_test simple_config_test simple_log_test epoll_socket_test
...
version_4http: test/version_4http.cpp
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(DEPS_INCLUDE_PATH) $(OUTPUT_INCLUDE_PATH) $< $(OUTPUT_LIB_PATH) $(DEPS_LIB_PATH) -o $(OUTPUT_TEST_DIR)/$@
